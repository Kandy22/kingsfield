...
from .linear import LinearModelConfig
...
def test_linear_model(
    ...
    model_config = LinearModelConfig(subject_layers_config=subject_layers_config, reduction=reduction)  # type: ignore
    ...
    if subject_layers_config is not None:
        assert isinstance(model.linear, SubjectLayers)
    else:
