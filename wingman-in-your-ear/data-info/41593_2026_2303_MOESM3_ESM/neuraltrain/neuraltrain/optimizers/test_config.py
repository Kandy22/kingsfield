...
from .base import LightningOptimizerConfig, TorchLRSchedulerConfig, TorchOptimizerConfig
...
def test_torch_lr_scheduler_config() -> None:
    ...
    lr_scheduler = TorchLRSchedulerConfig(
        name="OneCycleLR",
        kwargs={
            "max_lr": 0.1,
            "pct_start": 0.1,
...
def test_lightning_optimizer_config(scheduler_name) -> None:
    ...
    optimizer = LightningOptimizerConfig(
        ...
        model.parameters(), **scheduler_build_kwargs
    )  # type: ignore
