...
from neuralset.dataloader import SegmentData, SegmentDataset
...
class AugmentCollateSegments:

    def __init__(self, *args: tp.Any, **kwargs: tp.Any) -> None:
        msg = "AugmentCollateSegments is deprecated in favor of AugmentSegmentDataset"
