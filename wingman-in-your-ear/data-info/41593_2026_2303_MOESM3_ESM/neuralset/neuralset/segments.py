...
def intersection_segments(
    ...
    CAUTION: segment.ns_events field is not populated whithin this function (only
    indices are recorded through segment._index)
    """
    ...
    *,
    ...
    if idx is None:  # find from a specific time
        ...
        for segment in iter_segments(
            ...
            sel.extend(segment._index.tolist())  # type: ignore
...
class SegmentCreator:
    ...
    # see profiling in https://github.com/fairinternal/brainai/pull/1396
