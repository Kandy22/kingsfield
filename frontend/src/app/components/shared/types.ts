...
export type MikeChat = Chat;
export type MikeMessage = Message;
export type MikeCitationAnnotation = CitationAnnotation;
export type MikeEditAnnotation = EditAnnotation;
export type MikeWorkflow = Workflow;
export type MikeDocumentVersion = Document;
